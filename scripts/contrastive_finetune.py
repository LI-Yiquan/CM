...
def main():
    ...
    if model_path.endswith("pkl"):
        model = dist_util.load_state_dict(model_path, map_location="cpu")
    else:
    ...
    if len(args.teacher_model_path) > 0:  # path to the teacher score model.
        ...
        if args.teacher_model_path.endswith("pkl"):
            teacher_model = dist_util.load_state_dict(args.teacher_model_path, map_location="cpu")
        else:
